    ...
    function showMore() {
        window.addEventListener("load", (function(e) {
            ...
            function getHeight(showMoreBlock, showMoreContent) {
                ...
                console.log("Обчислена висота:", hiddenHeight);
                return hiddenHeight;
            }
            ...
            function setspoilerAction(e) {
                ...
                if (el.closest("summary") && el.closest("[data-spoilers]")) {
                    ...
                    if (el.closest("[data-spoilers]").classList.contains("_spoiler-init")) {
                        ...
                        const spoilerSpeed = spoilersBlock.dataset.spoilersSpeed ? parseInt(spoilersBlock.dataset.spoilersSpeed) : 0;
                        if (!spoilersBlock.querySelectorAll("._slide").length) {
                            ...
                            spoilerBlock.dispatchEvent(new CustomEvent("spoilerToggle", {
                                bubbles: true
                            }));
 ...
 */    var MEDIA_PREFERS_REDUCED_MOTION = "(prefers-reduced-motion: reduce)";
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        var gameSliderEl = document.querySelector(".game__slider");
        if (gameSliderEl) {
            var gameSlider = new Splide(gameSliderEl, {
                perPage: 1,
                arrows: true,
                pagination: false,
                gap: 10
    ...
    document.addEventListener("click", (e => {
        ...
        if (lang) e.target.closest(".lang") ? lang.classList.toggle("_active") : lang.classList.remove("_active");
    }));
    window["FLS"] = false;
    showMore();
    spoilers();
